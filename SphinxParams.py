...
import os
import functools  # Backport of reduce
...
class Group_p:
    ...
    def multiexpon(self, base, exps):
        return pow(base, functools.reduce(lambda x,y: x*y % self.__q, exps), self.__p)
...
class Group_ECC:
    ...
    def multiexpon(self, base, exps):
        ...
        return functools.reduce(self.expon, baseandexps)
...
if __name__ == '__main__':
    ...
    print(hexlify(p.hb(p.group.g, p.group.g)))
    print(hexlify(p.rho("1234" * 4)))
